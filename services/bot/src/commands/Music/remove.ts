module.exports = {
  name:"remove",aliases:["rm"],category:"Music",description:"Hapus lagu dari queue berdasarkan posisi",usage:"remove <posisi>",player:true,inVoiceChannel:true,sameVoiceChannel:true,
