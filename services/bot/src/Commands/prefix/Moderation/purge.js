...
module.exports = {
  ...
  execute:async(message,args,client)=>{
    if(!message.member.permissions.has(PermissionFlagsBits.ManageMessages))return message.reply({embeds:[client.embed().setDescription(client.emoji.cross+" Butuh izin **Manage Messages**.").setFooter({text:"Soraku Community"})]})
