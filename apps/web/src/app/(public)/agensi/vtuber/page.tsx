          ...
          <div key={v.id} className="glass-card overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="px-6 pb-6 pt-14 text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-accent mb-1">
                {v.model_type} Model · Debut {new Date(v.debut_date!).getFullYear()}
              </p>
              <h2 className="text-xl font-bold">{v.character_name}</h2>
              ...
              <div className="mt-5 flex justify-center gap-2">
                {v.socials.youtube && (
                  <a href={v.socials.youtube} target="_blank" rel="noopener noreferrer"
                ...
                {v.socials.twitter && (
                  <a href={v.socials.twitter} target="_blank" rel="noopener noreferrer"
