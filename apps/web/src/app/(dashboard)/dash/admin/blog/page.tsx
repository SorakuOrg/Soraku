    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/dash/admin/blog/new" className="flex items-center gap-1.5 rounded-xl bg-primary px-4 py-2 text-xs font-bold text-primary-foreground hover:bg-primary/90 transition-colors">
      ...
      {loading ? (
        ...
        <div className="glass-card py-16 text-center">
          ...
          <Link href="/dash/admin/blog/new" className="mt-4 inline-flex items-center gap-1.5 text-xs text-primary hover:underline">
