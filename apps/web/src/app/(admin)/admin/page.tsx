      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/blog" className="text-xs text-primary hover:underline">Lihat semua</Link>
          </div>
          {loading ? (
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/gallery" className="text-xs text-primary hover:underline">Moderasi</Link>
          </div>
          {loading ? (
            <div className="flex items-center gap-2 text-muted-foreground/40 py-4"><Loader2 className="h-4 w-4 animate-spin" /><span className="text-xs">Memuat…</span></div>
