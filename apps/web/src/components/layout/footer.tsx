...
const SOCIAL_LINKS = [
  { label: "Discord",    href: "https://discord.gg/qm3XJvRa6B",                                          icon: DiscordIcon   },
  { label: "Facebook",   href: "https://www.facebook.com/share/1HQs9ZZeCw/",                              icon: FacebookIcon  },
  { label: "Instagram",  href: "https://www.instagram.com/soraku.moe?igsh=MWxpcmNmd2tqZWE3MQ==",         icon: InstagramIcon },
  { label: "Twitter / X",href: "https://twitter.com/@AppSora",                                            icon: TwitterIcon   },
  { label: "TikTok",     href: "https://www.tiktok.com/@soraku.id?_r=1&_t=ZS-93VKUIkzmTM",               icon: TikTokIcon    },
  { label: "YouTube",    href: "https://youtube.com/@chsoraku?si=kcOs8wWCi7TwwC3P",                       icon: YouTubeIcon   },
] as const;
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="max-w-sm">
          ...
          <Link href="/" className="mb-4 inline-flex items-center gap-3 group">
            {/* Avatar / logo mark */}
            <div className="h-14 w-14 flex-shrink-0 overflow-hidden rounded-xl bg-[#1a1c20] border border-border/60 flex items-center justify-center shadow-md">
              <span className="text-2xl font-black leading-none select-none" style={{ color: "#4FA3D1" }}>
                空
              </span>
            </div>
          ...
          {/* Social icons — uniform style, seragam seperti referensi */}
