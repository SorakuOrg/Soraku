...
| 17 | Kaizo | Fix TS error `server.ts` + `middleware.ts` sesi ke-2 | `Parameters<CookieMethodsServer['setAll']>` gagal karena method optional. Fix: type inline `{ name: string; value: string; options?: Record<string, unknown> }[]` |
